> Note: I don't like deploying monorepos, so I have separate repos for server and client. You can find the server repo [here](https://github.com/burrowdown/codepath-meta-kudos-board-server)
